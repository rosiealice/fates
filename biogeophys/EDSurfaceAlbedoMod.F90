...
contains
  ...
  subroutine PatchNormanRadiation (currentPatch, &
    ...
    real(r8) :: frac_lai(nclmax,maxpft,nlevleaf)
    real(r8) :: frac_sai(nclmax,maxpft,nlevleaf)
    real(r8) :: f_abs(nclmax,maxpft,nlevleaf,maxSWb)                   ! Fraction of light absorbed by surfaces.
    real(r8) :: rho_layer(nclmax,maxpft,nlevleaf,maxSWb)
    real(r8) :: tau_layer(nclmax,maxpft,nlevleaf,maxSWb)
